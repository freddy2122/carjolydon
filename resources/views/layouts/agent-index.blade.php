...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/administer" class="logo d-flex align-items-center">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-layout-text-window-reverse"></i><span>Gestion de commandes</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="/agentpages/client">
                            <i class="bi bi-circle"></i><span>Clients</span>
                        </a>
                    </li>
                    <li>
                        <a href="/agentpages/commandes">
                            <i class="bi bi-circle"></i><span>Commandes</span>
                        </a>
                    </li>

                    <li>
                        <a href="/agentpages/suivicommandes">
                            <i class="bi bi-circle"></i><span>Suivi</span>
                        </a>
                    </li>
                    <li>
                        <a href="/agentpages/rendezvous">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-bar-chart"></i><span>Facturation et paiement</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
